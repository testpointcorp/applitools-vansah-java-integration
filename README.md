...
Follow the instructions below to integrate [Applitools](https://applitools.com/) with Vansah Test Management for Jira using Java. The integration will allow you to send your test case results to Vansab
